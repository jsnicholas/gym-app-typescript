      ...
      {isAboveMediumScreens && (
        <div className="h-[150px] w-full bg-primary-100 py-10">
          <div className="mx-auto w-5/6">
            {/* set width to 3/5 to avoid overlap of image and sponsors on short wide screens*/}
            <div className="flex w-3/5 items-center justify-between gap-8">
              <img src={SponsorRedBull} alt="RedBull-sponsor-image" />
              <img src={SponsorFortune} alt="Fortune-sponsor-image" />
              <img src={SponsorForbes} alt="Forbes-sponsor-image" />
            </div>
          </div>
        </div>
      )}
